...
export const Sidenav = ({menuset}) => {
  ...
  return (
    <div className={`sidenav duration-300 w-[20%] sm:overflow-y-auto sm:z-[100] sm:w-[50%] sm:absolute ${menuset ? "sm:left-0" : "sm:left-[-100%]"}  h-[100vh] overflow-y-auto bg-[#5f727a]  p-5`}>
